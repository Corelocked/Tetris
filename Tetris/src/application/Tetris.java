	...
	public void start(Stage stage) throws Exception {
		...
		level.setFill(Color.GREEN);
                ...
                Text controls = new Text( """
                                          ...
                                          S/DOWN arrow: Down
                                          """);
                controls.setStyle("-fx-font: 13 arial;");
                controls.setY(150);
                controls.setX(XMAX + 5);
                controls.setFill(Color.BLACK);
                
		group.getChildren().addAll(scoretext, line, level, controls);
	...
	private void moveOnKeyPress(Form form) {
		scene.setOnKeyPressed((KeyEvent event) -> {
                    switch (event.getCode()) {
                        ...
                        case D -> Controller.MoveRight(form);
                        case S -> {
                            MoveDown(form);
                            score++;
                        }
                        case A -> Controller.MoveLeft(form);
                        case W -> MoveTurn(form);
                    }
                });
	}
